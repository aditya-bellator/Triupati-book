...
const ToWinTheTossBet = (
  // { onclickHide }
  props
) => {

  let { betSlipData, finalMatchStack, updateStackOnclic, inputChange, inputChangeDisable, selectStackNewToWinTheToss, decreaseCount, increaseCount, handlePlaceBetToWinTheToss, handlestakeOpenWeb, count, stack, onclickHide, increaseStack, decreaseStack, handleReset, showValuesModalhander, valuesModal, handleCurrentIndex, handleStakeInput, handlesSaveUserStack, profit, handleInputStackToWinTheToss, loadingBetPlace } = props;
              ...
              <div className="place-bet-box-body">
                ...
                <div className="place-bet-stake">
                  ...
                  <input
                    ...
                    placeholder="0"
                    value={stack}
                    onChange={handleInputStackToWinTheToss}
                  />
                  <div className="spinner-buttons input-group-btn btn-group-vertical">
                      ...
                      finalMatchStack.map((element, index) => (
                        <>
                          <button className="btn btn-place-bet" fdprocessedid="ajrch"
                            onClick={() => selectStackNewToWinTheToss(element)}
              ...
              <div className="place-bet-action-buttons">
                ...
                <div>
                  ...
                  <button
                    ...
                    fdprocessedid="vkeld"
                    disabled=""
                    onClick={handlePlaceBetToWinTheToss}
                  >
                    Submit
                  </button>
                </div>
...
export default ToWinTheTossBet;

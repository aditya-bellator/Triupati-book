...
const CompleteMatchBet = (
  // { onclickHide }
  props
) => {

  let { betSlipData, finalMatchStack, updateStackOnclic, inputChange, inputChangeDisable, selectStackNewComplateMatch, decreaseCount, increaseCount, handlePlaceBetCompleteMatch, handlestakeOpenWeb, count, stack, onclickHide, increaseStack, decreaseStack, handleReset, showValuesModalhander, valuesModal, handleCurrentIndex, handleStakeInput, handlesSaveUserStack, profit, handleInputStackCompletematch, loadingBetPlace } = props;
              ...
              <div className="place-bet-box-body">
                ...
                <div className="place-bet-stake">
                  ...
                  <input
                    ...
                    placeholder="0"
                    value={stack}
                    onChange={handleInputStackCompletematch}
                  />
                  <div className="spinner-buttons input-group-btn btn-group-vertical">
                      ...
                      finalMatchStack.map((element, index) => (
                        <>
                          <button className="btn btn-place-bet" fdprocessedid="ajrch"
                            onClick={() => selectStackNewComplateMatch(element)}
              ...
              <div className="place-bet-action-buttons">
                ...
                <div>
                  ...
                  <button
                    ...
                    fdprocessedid="vkeld"
                    disabled=""
                    onClick={handlePlaceBetCompleteMatch}
                  >
                    Submit
                  </button>
                </div>
...
export default CompleteMatchBet;

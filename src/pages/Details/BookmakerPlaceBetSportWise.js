...
const BookmakerPlaceBetSportWise = (
  // { onclickHide }
  props
) => {

  let { betSlipData, finalMatchStack, updateStackOnclic, inputChange, inputChangeDisable, selectStackNewBookmakerSportWise, decreaseCount, increaseCount, handlePlaceBet, handlestakeOpenWeb, count, stack, onclickHide, increaseStack, decreaseStack, handleReset, showValuesModalhander, valuesModal, handleCurrentIndex, handleStakeInput, handlesSaveUserStack, profit, handleInputStack, handleInputStackBookMakerSportWise, loadingBetPlace } = props;
              ...
              <div className="place-bet-box-body">
                ...
                <div className="place-bet-stake">
                  ...
                  <input
                    ...
                    placeholder="0"
                    value={stack}
                    onChange={handleInputStackBookMakerSportWise}
                  />
                  <div className="spinner-buttons input-group-btn btn-group-vertical">
                      ...
                      finalMatchStack.map((element, index) => (
                        <>
                          <button className="btn btn-place-bet" fdprocessedid="ajrch"
                            onClick={() => selectStackNewBookmakerSportWise(element)}
                          >
                            {/* {element ? element : ""} */}
...
export default BookmakerPlaceBetSportWise;

...
export default function BetPlaceMobileView(props) {
  ...
  let { handleReset, finalMatchStack, betSlipData, handleInputStack, fancyPlaceBet, stack, count, profit, selectStackNew, MatchDetails, sectionType, currentRunner, valuesModal,
    showValuesModalhander, handleCurrentIndex, handleStakeInput, handlesSaveUserStack, updateStackOnclic,
    backBetFancyModal, inputChange, loadingBetPlace
  } = props;

  // console.log('betSlipData____fancy___mobile??', betSlipData);
          ...
          <div className="background">
            <div className="d-flex align-items-end justify-content-between mb-2 px-1">
              <p className="fst-bold m-0"><strong>
                {betSlipData && betSlipData.element && betSlipData.element.RunnerName ? betSlipData.element.RunnerName : "-"}
                {/* Welligton */}
              </strong></p>
            ...
            <div className="d-flex mb-2">
              <div className="col-4 px-1 pe-3">
                <input type="text" className="place" value={stack} onChange={inputChange} style={{ height: "30px", width: "100%", borderRadius: "3px" }} />
              </div>
              <div className="col-4 px-1" >
                <button className="place bg-blue rounded-1 border-0 btn-prime" onClick={fancyPlaceBet} >Submit</button>
              </div>
              <div className="col-4 px-1">
                    ...
                    finalMatchStack.map((element, index) => (
                      <>
                        ...
                        <div className="col-4 px-1 mb-2"
                          ...
                          onClick={() => updateStackOnclic(element)}
                        >
